<template>
    <div :class="componentClass">
        <div :class="ui[props.type.toLowerCase()]?.header || ''">
            <svg
                v-if="type.toLowerCase() === 'tip'"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 384 512"
                :class="ui[props.type.toLowerCase()]?.icon || ''"
            >
...
const componentClass = computed(() => {
    const baseClass = ui.component
    const typeClass = ui[props.type.toLowerCase()]?.component || ''
